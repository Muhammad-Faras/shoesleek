"""
Django settings for shoesleek project.
...
SECRET_KEY = 'django-insecure-#z-7j$h59=xgre_72qsl!zmnjp0oql$w(ygy0^7sxovlvez1*m'
...
WSGI_APPLICATION = 'shoesleek.wsgi.application'
